        ...
        <section className="bg-white">
            <div className="px-4 pb-8 py-8">
                ...
                <div className="lg:flex justify-center max-w-6xl mx-auto">
                    <div className="sm:bg-light-grey-blue lg:bg-transparent sm:p-8 sm:flex lg:flex-col items-start gap-4 lg:w-full shrink">
                        <div className="mt-8 sm:mt-0 sm:w-1/2 lg:w-full h-52 overflow-hidden">
                            <Image src="/imgs/map-1.png" layout="responsive" width={393} height={314} />
                        </div>
                        <div className="sm:w-1/2 lg:w-full">
                            <h6 className="text-primary-600 text-lg mt-6 sm:mt-0 font-russo">TOTEM LODGE</h6>
                    ...
                    <div className="sm:bg-light-grey-blue lg:bg-transparent sm:p-8 sm:flex lg:flex-col items-start gap-4 lg:w-full shrink sm:mt-8 lg:mt-0">
                        <div className="mt-8 sm:mt-0 sm:w-1/2 lg:w-full h-52 overflow-hidden">
                            <Image src="/imgs/map-2.png" layout="responsive" width={393} height={314} />
                        </div>
                        <div className="sm:w-1/2 lg:w-full">
                            <h6 className="text-primary-600 text-lg mt-6 sm:mt-0 font-russo">YELLOWBIRD LODGE</h6>
                            <p className="text-gray-700 mt-4">
                    ...
                    <div className="sm:bg-light-grey-blue lg:bg-transparent sm:p-8 sm:flex lg:flex-col items-start gap-4 lg:w-full shrink sm:mt-8 lg:mt-0">
                        <div className="mt-8 sm:mt-0 sm:w-1/2 lg:w-full h-52 overflow-hidden">
                            <Image src="/imgs/map-3.png" layout="responsive" width={393} height={314} />
                        </div>
                        <div className="sm:w-1/2 lg:w-full">
                            <h6 className="text-primary-600 text-lg mt-6 sm:mt-0 font-russo">WILEY POINT LODGE</h6>
                            <p className="text-gray-700 mt-4">
                                1. Main Lodge:<br />
