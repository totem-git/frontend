...
const Variant6 = ({ data, prependBreadcrumbs }) => {
  let picture = data.media[0];

  return (
    <>
      {prependBreadcrumbs && <Breadcrumbs bgColor="bg-light-grey-blue" />}
      <section
        id={data.identifier}
        className="overflow-x-hidden bg-light-grey-blue py-8 md:px-4"
        data-section-name="GeneralPurposeSection:Variant6"
      >
        {data.title && (
        ...
        <div className="flex max-w-none flex-col items-center space-y-4 md:flex-col-reverse lg:flex-row-reverse lg:items-start xl:px-16">
          ...
          <div className="container relative flex-1 space-y-4 sm:pl-2 lg:min-w-[65ch] lg:pl-0">
