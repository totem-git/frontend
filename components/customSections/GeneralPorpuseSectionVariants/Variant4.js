...
const Variant4 = ({ data }) => {
    return (
        <section className="py-8 md:py-12 overflow-x-hidden bg-white">
            {/* <h4 className="hidden mb-6 text-3xl font-thin text-center sm:block lg:hidden text-primary-600 font-russo">{data.title}</h4> */}
            <div className="lg:container px-4 mx-auto flex flex-col justify-center items-center max-w-md space-y-4 md:space-y-0 md:space-x-4 sm:max-w-4xl lg:max-w-6xl xl:max-w-none xl:px-16 sm:flex-row">
                <div className="relative flex-1 w-full p-4 max-w-[350px] lg:max-w-xl">
                    <span className="absolute bottom-0 w-screen -translate-x-1/2 sm:w-auto left-1/2 sm:-right-8 sm:-left-24 -top-3 sm:translate-x-0" style={{
