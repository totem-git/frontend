...
const GeoInfo = ({ data, prependBreadcrumbs }) => {
      ...
      <section data-section-name="GeoInfo" className="bg-white py-8 px-4">
        <div className="lg:container">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-center leading-snug text-gray-700">
            ...
            anywhere in Canada & the USA. We are just a short 90 mile drive
            North of the International Falls border crossing, and just a short 3
            hour drive from Winnipeg, Manitoba.
          </p>
