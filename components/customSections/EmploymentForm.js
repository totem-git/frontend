...
const EmploymentForm = ({ prependBreadcrumbs }) => {
  ...
  return (
    <>
      ...
      <div
        className="mx-2 mt-10 flex flex-col items-center justify-center pb-20"
        data-section-name="EmploymentForm"
      >
          ...
          <div className="flex flex-col space-y-4 bg-inherit lg:space-y-2">
            <div className="relative bg-inherit">
              ...
              >
                ...
                <option value="Shorelunch Prep Cook">
                  Shorelunch Prep Cook
                </option>
